...
export default function HomeTab({ onTabChange, onShowAllNews, onSelectNews }: HomeTabProps) {
  ...
  return (
    <div className="space-y-16">
      {/* Hero Section */}
      <section className="py-16 bg-gradient-to-br from-slate-50 via-blue-50/30 to-red-50/20 relative overflow-hidden">
        {/* Animated Background */}
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div
                className={`inline-flex items-center px-4 py-2 bg-red-600/10 rounded-full border border-red-600/20 transition-all duration-1000 ${isVisible ? "animate-fade-in-down" : "opacity-0"}`}
              >
                <span className="text-red-600 text-sm font-medium tracking-wide">Desde 2021 transformando vidas</span>
              </div>

              <h1
                className={`text-4xl md:text-5xl font-bold leading-tight tracking-tight transition-all duration-1000 delay-200 ${isVisible ? "animate-fade-in-left" : "opacity-0"}`}
              >
              ...
              <p
                className={`text-xl text-slate-600 leading-relaxed transition-all duration-1000 delay-400 ${isVisible ? "animate-fade-in-left" : "opacity-0"}`}
              >
                Formamos atletas e cidadãos através do esporte, educação e valores fundamentais para a vida.
              </p>

              <div
                className={`flex flex-col sm:flex-row gap-4 transition-all duration-1000 delay-600 ${isVisible ? "animate-fade-in-up" : "opacity-0"}`}
              >
                <Button
                  size="lg"
                  className="bg-red-600 hover:bg-red-700 text-white font-medium px-8 py-4 group hover-lift btn-hover-lift ripple"
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="border-2 border-slate-300 text-slate-700 hover:bg-slate-50 font-medium px-8 py-4 bg-transparent hover-lift"
            ...
            >
              <div className="bg-white rounded-3xl p-6 shadow-2xl shadow-slate-900/10 hover-lift card-hover">
                <Image
              ...
              <div className="absolute -bottom-3 -right-3 w-16 h-16 bg-red-600 rounded-2xl opacity-20 animate-float"></div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {statsData.map((stat, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-16 h-16 bg-${stat.color}-100 rounded-full flex items-center justify-center mx-auto mb-4 hover-scale animate-float`}
                  >
                    {typeof stat.icon === "string" ? (
                      <span className="text-2xl">{stat.icon}</span>
                    ) : (
                      <stat.icon className={`w-8 h-8 text-${stat.color}-600 icon-bounce`} />
                    )}
                  </div>
      ...
      <section className="py-16 bg-gradient-to-br from-blue-50 to-slate-50">
        <div className="container mx-auto px-6">
          <div
            className={`text-center mb-12 transition-all duration-1000 delay-1800 ${isVisible ? "animate-fade-in-up" : "opacity-0"}`}
          >
            <div className="inline-flex items-center px-4 py-2 bg-blue-100 rounded-full mb-6 hover-scale">
              <span className="text-blue-700 text-sm font-medium tracking-wide">Nossos Parceiros</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Patrocínio e Apoio</h2>
          ...
          <div className="max-w-4xl mx-auto">
            {/* Main Partner - CEAP */}
            <div
              className={`bg-white rounded-3xl p-8 shadow-xl shadow-slate-900/5 border border-slate-200 mb-12 hover-lift card-hover transition-all duration-1000 delay-2000 ${isVisible ? "animate-scale-in" : "opacity-0"}`}
            >
              <div className="text-center mb-8">
                <div className="inline-flex items-center px-4 py-2 bg-blue-50 rounded-full mb-4 hover-scale">
                  <span className="text-blue-700 text-sm font-medium tracking-wide">Parceiro Principal</span>
                </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                <CardContent className="p-8 text-center h-full flex flex-col justify-center">
                  <div className="w-16 h-16 bg-slate-100 rounded-full flex items-center justify-center mx-auto mb-6 hover-scale animate-float">
                    <span className="text-3xl">🤝</span>
                  </div>
                  <h3 className="text-xl font-bold text-slate-900 mb-4">Seja Nosso Parceiro</h3>
                  <p className="text-slate-600 mb-6 leading-relaxed">
                    Sua empresa pode fazer parte desta transformação social e ajudar a formar o futuro de centenas de
                    crianças e adolescentes.
                  </p>
                  <Button
                    className="bg-blue-900 hover:bg-blue-800 text-white font-medium hover-lift btn-hover-lift ripple"
              ...
              >
                <CardContent className="p-8">
                  <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mb-6 hover-scale animate-float">
                    <span className="text-3xl">💚</span>
                  </div>
                  <h3 className="text-xl font-bold text-slate-900 mb-4">Como Apoiar</h3>
                  ...
                  <Button
                    variant="outline"
                    className="w-full mt-6 border-2 border-green-600 text-green-600 hover:bg-green-50 bg-transparent hover-lift"
                    onClick={() => onTabChange("parcerias")}
                  >
                    Ver Detalhes
                  </Button>
      ...
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-6">
          <div
            className={`text-center mb-12 transition-all duration-1000 delay-3000 ${
              isVisible ? "animate-fade-in-up" : "opacity-0"
            }`}
          >
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Conheça Nossa Escola</h2>
            <p className="text-xl text-slate-600">Descubra tudo o que oferecemos para formar atletas e cidadãos</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              return (
                <Card
                  key={index}
                  className={`hover:shadow-xl transition-all duration-1000 delay-${3200 + index * 100} cursor-pointer border-2 hover:border-${card.color}-300 card-hover hover-lift ${
                ...
                >
                  <CardContent className="p-6 text-center">
                    <div
                      className={`w-16 h-16 bg-${card.color}-100 rounded-full flex items-center justify-center mx-auto mb-4 hover-scale animate-float`}
                    >
                      <IconComponent className={`w-8 h-8 text-${card.color}-600 icon-bounce`} />
                    </div>
                    <h3 className="text-xl font-bold text-slate-900 mb-3">{card.title}</h3>
                    <p className="text-slate-600 mb-4">{card.description}</p>
                    <Button variant="ghost" className={`text-${card.color}-600 hover:text-${card.color}-700`}>
                      {card.title === "Fale Conosco" ? "Contatar" : "Saiba Mais"}
                      <ArrowRight className="ml-2 w-4 h-4 icon-bounce" />
                    </Button>
                  </CardContent>
                </Card>
              )
      ...
      {/* CTA Final */}
      <section className="py-16 bg-gradient-to-r from-red-600 to-blue-900 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-red-600/90 to-blue-900/90"></div>
        <div className="container mx-auto px-6 text-center relative z-10">
          <h2
            className={`text-3xl md:text-4xl font-bold text-white mb-6 transition-all duration-1000 delay-3800 ${isVisible ? "animate-fade-in-up" : "opacity-0"}`}
          >
            Faça Parte da Nossa História
          </h2>
          <p
            className={`text-xl text-red-100 mb-8 max-w-2xl mx-auto transition-all duration-1000 delay-4000 ${isVisible ? "animate-fade-in-up" : "opacity-0"}`}
          >
            Venha conhecer nossa escola e descobrir como podemos ajudar no desenvolvimento do seu filho
          </p>
          <div
            className={`flex flex-col sm:flex-row gap-4 justify-center transition-all duration-1000 delay-4200 ${isVisible ? "animate-fade-in-up" : "opacity-0"}`}
          >
            <Button
              size="lg"
              className="bg-white text-red-600 hover:bg-slate-100 font-medium px-8 py-4 hover-lift btn-hover-lift ripple"
              onClick={handleContactClick}
            >
              Inscrever Agora
            </Button>
            <Button
              size="lg"
              variant="outline"
              className="border-2 border-white text-white hover:bg-white hover:text-red-600 font-medium px-8 py-4 bg-transparent hover-lift"
